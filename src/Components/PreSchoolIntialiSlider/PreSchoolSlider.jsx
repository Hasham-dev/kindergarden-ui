    ...
    <>
      ...
      <div className='flex space-x-4 flex-row flex-wrap lg:text-lg justify-center items-center space-y-1 md:space-y-0 pb-8'>
        <span className='flex w-1/5 flex-col lg:flex-row'>
          ...
          <span className='text-white font-bold font-xs hidden lg:block md:text-lg w-30 mt-4'>
            8:00 - 17:30
            <br />
            Full time
          </span>
        ...
        <span className='flex w-1/5 flex-col lg:flex-row'>
          ...
          <span className='text-white font-bold hidden lg:block font-xs md:text-lg w-30 mt-4'>
            Age based programs,
            <br />
            Having fun while
            <br />
